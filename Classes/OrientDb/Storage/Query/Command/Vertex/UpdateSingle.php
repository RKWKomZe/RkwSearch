...
class UpdateSingle extends \RKW\RkwSearch\OrientDb\Storage\Query\Command\Vertex implements \RKW\RkwSearch\OrientDb\Storage\Query\Command\VertexInterface {

    /**
     * Builds a new statement, setting the $rid
     *
     * @param string $rid
     */
    ...
    protected function getSchema() {
        ...
        return "UPDATE :tId :ActionOne :UpdatesOne :ActionTwo :UpdatesTwo :Where";
        //===
    }
